var store = [{
        ...
        "excerpt":"14장 전역 변수의 문제점 14.1 변수의 생명 주기 14.1.1 지역 변수의 생명 주기 변수는 자신이 선언된 위치에서 생성되고 소멸한다. 함수 내부에서 선언한 변수는 함수가 호출된 직후에 함수 몸체의 코드가 한줄씩 순차적으로 실행되기 이전에 자스크립트 엔진에 의해 먼저 실행된다. 즉, 지역변수의 생명주기는 함수의 생명 주기와 같다. 변수는 메모리공간에 저장 되었다가 저장된...","categories": ["js"],
        "tags": ["javascript"],
        "url": "/js/modernJS14/",
        "teaser": null
      }]
